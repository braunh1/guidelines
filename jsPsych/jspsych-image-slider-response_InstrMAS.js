  ...
  class CustomImageSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      if (trial.render_on_canvas) {
        ...
        // Add vertical lines
        html += '<div class="slider-lines" style="position: absolute; width: 100%; height: 20px; display: flex; justify-content: space-between;">';
        html += '<div class="line" style="width: 2px; height: 20px; background-color: white;"></div>';
        html += '<div class="line" style="width: 2px; height: 20px; background-color: white;"></div>';
        html += '<div class="line" style="width: 2px; height: 20px; background-color: white;"></div>';
        html += '</div>';
        html +=
